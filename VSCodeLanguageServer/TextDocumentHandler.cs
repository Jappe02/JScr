...
namespace VSCodeLanguageServer
{
    internal class TextDocumentHandler : TextDocumentSyncHandlerBase
    {
        ...
        public override TextDocumentAttributes GetTextDocumentAttributes(DocumentUri uri) => new TextDocumentAttributes(uri, "jscrlang");
    }
    ...
    internal class MyDocumentSymbolHandler : IDocumentSymbolHandler
    {
        ...
        {
            DocumentSelector = TextDocumentSelector.ForLanguage("jscrlang")
        };
    }
